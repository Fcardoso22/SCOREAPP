...
namespace SCORE.Data.Migrations
{
    ...
    [Migration("20240613210917_AddExercicioOpcao")]
    partial class AddExercicioOpcao
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SCORE.Models.Opcao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SCORE.Models.Opcao", b =>
                {
                    b.HasOne("SCORE.Models.Exercicio", "Exercicio")
                        .WithMany("Opcoes")
